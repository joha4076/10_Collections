...
namespace _10_Collections
{
    ...
    public class CollectionsTest
    {
        ...
        public void CanCopyElementsToAFacadeInterface()
        {
            ...
            portfolio.AddIAsset(stockIBM);
            portfolio.AddIAsset(stockHP);
            portfolio.AddIAsset(stockYHOO);
        ...
        [TestMethod]
        public void CanGetIAssetByName()
        {
            Portfolio portfolio = new Portfolio();
            portfolio.AddIAsset(stockIBM);
            portfolio.AddIAsset(stockHP);
            ...
            Assert.AreEqual(stockIBM, portfolio.GetIAssetByName("IBM"));
            Assert.AreEqual(stockHP, portfolio.GetIAssetByName("HPQ"));
            Assert.AreEqual(stockYHOO, portfolio.GetIAssetByName("YHOO"));

            Assert.IsNull(portfolio.GetIAssetByName("QQQQ"));
        }
